        ...
        return (
          <div
            ...
            style={{
              ...
              padding: "16px 20px",
              marginBottom: "10px",
              border: done.value ? `1px solid ${ok ? "#23a55a" : "#f23f43"}` : "1px solid #3f4147",
        ...
        : (
          <div
            style={{
              ...
              fontWeight: "700",
              marginTop: "6px",
              background: score === 5 ? "#1e3a2a" : score >= 3 ? "#2a2d1e" : "#3a1e1e",
              color: score === 5 ? "#23a55a" : score >= 3 ? "#f0b232" : "#f23f43",
